...
const SelectedBeneficiary = ({
  ...
  useEffect(() => {
    ...
    if (allCompleted && successfulTxns.length > 0) {
      ...
      // FIX: Check if current row is completed and move to next
      ...
      if (
        ...
        // Wait a bit before moving to next row for better UX
  ...
  const handleNavigateToRow = (rowIndex) => {
    if (rowIndex >= 0 && rowIndex < amountRows.length) {
      ...
      <div class="receipt-container">
        ...
        <div class="section">
          ...
          <div class="row">
            ...
            <span class="value">${sender?.mobileNumber || "N/A"}</span>
          </div>
          <div class="row">
            <span class="label">Sender:</span>
            <span class="value">${sender?.firstName || ""} ${
      sender?.lastName || ""
    }</span>
          </div>
        </div>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        >
          ...
          >
            ...
            <Typography variant="body1">{sender.mobileNumber}</Typography>
          </Box>
